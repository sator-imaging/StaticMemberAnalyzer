...
namespace SatorImaging.MeticulousAnalyzer.Analysis.Analyzers
{
    ...
    public sealed class FlakyInitializationAnalyzer : DiagnosticAnalyzer
    {
        ...
        private static readonly DiagnosticDescriptor Rule_WrongInit = new(
            ...
            description: new LocalizableResourceString(nameof(Resources.SMA0001_MessageFormat), Resources.ResourceManager, typeof(Resources), "$variable"));
        ...
        private static readonly DiagnosticDescriptor Rule_CrossRef = new(
            ...
            DiagnosticSeverity.Error,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0002_MessageFormat), Resources.ResourceManager, typeof(Resources), "$variable", "$type"));
        ...
        private static readonly DiagnosticDescriptor Rule_AnotherFile = new(
            ...
            DiagnosticSeverity.Error,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0003_MessageFormat), Resources.ResourceManager, typeof(Resources), "$variable"));
        ...
        private static readonly DiagnosticDescriptor Rule_LateDeclare = new(
            ...
            DiagnosticSeverity.Error,
            isEnabledByDefault: true,
            description: new LocalizableResourceString(nameof(Resources.SMA0004_MessageFormat), Resources.ResourceManager, typeof(Resources), "$variable1", "$variable2"));
